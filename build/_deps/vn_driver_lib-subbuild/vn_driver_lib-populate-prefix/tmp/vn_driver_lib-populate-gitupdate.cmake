...
execute_process(
  COMMAND "/usr/bin/git" show-ref "0d40803"
  WORKING_DIRECTORY "/app/build/_deps/vn_driver_lib-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("0d40803" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/0d40803")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/app/build/_deps/vn_driver_lib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/app/build/_deps/vn_driver_lib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
