    ...
    std::shared_ptr<google::protobuf::Message> msg)
{
    ...
    else if (msg->GetDescriptor() == hytech_msgs::EkfState::descriptor())
    {
        ...
        // For now, whenever the EKF state is updated, log and update the overall VehicleData message
        ...
        vehicle_data_msg->set_prev_mcu_recv_millis(snapshot.prev_MCU_recv_millis);
        ...
        vehicle_data_msg->set_electrical_power_watts(snapshot.old_energy_meter_kw * 1000.0f);
        ...
        auto* current_body_vel_msg = vehicle_data_msg->mutable_current_body_vel_ms();
        ...
        auto* current_body_accel_msg = vehicle_data_msg->mutable_current_body_accel_mss();
        ...
        auto* current_angular_rate_msg = vehicle_data_msg->mutable_current_angular_rate_rads();
        ...
        tire_forces_msg->mutable_fl()->set_x(snapshot.tire_dynamics.tire_forces_n.FL.x);
        tire_forces_msg->mutable_fl()->set_y(snapshot.tire_dynamics.tire_forces_n.FL.y);
        tire_forces_msg->mutable_fl()->set_z(snapshot.tire_dynamics.tire_forces_n.FL.z);
        tire_forces_msg->mutable_fr()->set_x(snapshot.tire_dynamics.tire_forces_n.FR.x);
        tire_forces_msg->mutable_fr()->set_y(snapshot.tire_dynamics.tire_forces_n.FR.y);
        tire_forces_msg->mutable_fr()->set_z(snapshot.tire_dynamics.tire_forces_n.FR.z);
        tire_forces_msg->mutable_rl()->set_x(snapshot.tire_dynamics.tire_forces_n.RL.x);
        tire_forces_msg->mutable_rl()->set_y(snapshot.tire_dynamics.tire_forces_n.RL.y);
        tire_forces_msg->mutable_rl()->set_z(snapshot.tire_dynamics.tire_forces_n.RL.z);
        tire_forces_msg->mutable_rr()->set_x(snapshot.tire_dynamics.tire_forces_n.RR.x);
        tire_forces_msg->mutable_rr()->set_y(snapshot.tire_dynamics.tire_forces_n.RR.y);
        tire_forces_msg->mutable_rr()->set_z(snapshot.tire_dynamics.tire_forces_n.RR.z);

        auto* tire_moments_msg = tire_dyn_msg->mutable_tire_moments_nm();
        tire_moments_msg->mutable_fl()->set_x(snapshot.tire_dynamics.tire_moments_nm.FL.x);
        tire_moments_msg->mutable_fl()->set_y(snapshot.tire_dynamics.tire_moments_nm.FL.y);
        tire_moments_msg->mutable_fl()->set_z(snapshot.tire_dynamics.tire_moments_nm.FL.z);
        tire_moments_msg->mutable_fr()->set_x(snapshot.tire_dynamics.tire_moments_nm.FR.x);
        tire_moments_msg->mutable_fr()->set_y(snapshot.tire_dynamics.tire_moments_nm.FR.y);
        tire_moments_msg->mutable_fr()->set_z(snapshot.tire_dynamics.tire_moments_nm.FR.z);
        tire_moments_msg->mutable_rl()->set_x(snapshot.tire_dynamics.tire_moments_nm.RL.x);
        tire_moments_msg->mutable_rl()->set_y(snapshot.tire_dynamics.tire_moments_nm.RL.y);
        tire_moments_msg->mutable_rl()->set_z(snapshot.tire_dynamics.tire_moments_nm.RL.z);
        tire_moments_msg->mutable_rr()->set_x(snapshot.tire_dynamics.tire_moments_nm.RR.x);
        tire_moments_msg->mutable_rr()->set_y(snapshot.tire_dynamics.tire_moments_nm.RR.y);
        tire_moments_msg->mutable_rr()->set_z(snapshot.tire_dynamics.tire_moments_nm.RR.z);
        ...
        vehicle_data_msg->set_psi_dot_lm_rad_s(snapshot.tire_dynamics.psi_dot_lm_rad_s);
        ...
        auto* tv_torque_additional_msg = tv_status_msg->mutable_torque_additional_nm();
        ...
        auto* suspension_msg = vehicle_data_msg->mutable_suspension_potentiometers_mm();
        ...
        auto* current_torques_msg = vehicle_data_msg->mutable_current_torques_nm();
        ...
        core::log(std::static_pointer_cast<google::protobuf::Message>(vehicle_data_msg));
